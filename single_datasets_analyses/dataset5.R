...
#check, import in R and process sequences from dataset 5
...
#echo $filename
#java -jar /home/gilda/Trimmomatic-0.39/trimmomatic-0.39.jar PE $file ${filename}_2.fastq.gz ${filename}_R1_paired.fastq.gz ${filename}_R1_unpaired.fastq.gz ${filename}_R2_paired.fastq.gz ${filename}_R2_unpaired.fastq.gz CROP:250 ILLUMINACLIP:../Trimmomatic-0.39/adapters/all.fa:2:30:10  
#done

#set working directory
setwd("/home/gilda/dataset5")

#import/save R environment
#save.image(file='dataset5_16S.RData')
...
sample.names <- sapply(strsplit(basename(fnFs), "R1_paired.fastq.gz"), `[`, 1)
sample.names
...
dir.create("/home/gilda/dataset5/quality_plots")
library("gridExtra")
#raw forward
...
#282954597 total bases in 1230264 reads from 1 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#246046895 total bases in 1230264 reads from 1 samples will be used for learning the error rates.
...
#Identified 655 bimeras out of 12813 input sequences.
dim(seqtab.nochim)
#[1]     6 12158
...
head(track)
write.table(track, file = "dataset5_read_count.txt", sep = "\t")
