...
#check, import in R and process sequences from dataset 8
...
#for file in *_L001_R1_001.fastq.gz
#do
#filename="${file%_L001_R1_001.fastq.gz}"
#echo $filename
...
setwd("/home/gilda/dataset8")

#import/save R environment
#save.image(file='dataset8_16S.RData')
...
dir.create("/home/gilda/dataset8/quality_plots")
library("gridExtra")
#raw forward
...
#100548688 total bases in 400837 reads from 45 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#100331017 total bases in 400837 reads from 45 samples will be used for learning the error rates.
...
#Identified 36 bimeras out of 7736 input sequences.
dim(seqtab.nochim)
#[1]  114 7700
...
head(track)
write.table(track, file = "dataset8_read_count.txt", sep = "\t")
