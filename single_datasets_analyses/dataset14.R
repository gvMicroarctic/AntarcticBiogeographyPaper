...
#check, import in R and process sequences from dataset 14
...
setwd("/home/gilda/dataset14")

#import/save R environment
#save.image(file='dataset14_16S.RData')
...
dir.create("/home/gilda/dataset14/quality_plots")
library("gridExtra")
#raw forward
...
#102922799 total bases in 706448 reads from 41 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#102195413 total bases in 854318 reads from 47 samples will be used for learning the error rates.
...
#Identified 103 bimeras out of 5931 input sequences.
dim(seqtab.nochim)
#[1]   84 5828
...
head(track)
write.table(track, file = "dataset14_read_count.txt", sep = "\t")
