...
#check, import in R and process sequences from dataset 9
...
#for file in *_R1.fastq.gz
#do
#filename0="${file%_R1.fastq.gz}"
#filename="${filename0#*.s}"
#echo $filename
#java -jar /home/gilda/Trimmomatic-0.39/trimmomatic-0.39.jar PE $file ${filename0}_R2.fastq.gz ${filename}_R1_paired.fastq.gz ${filename}_R1_unpaired.fastq.gz ${filename}_R2_paired.fastq.gz ${filename}_R2_unpaired.fastq.gz ILLUMINACLIP:../Trimmomatic-0.39/adapters/all.fa:2:30:10
#done

#set working directory
setwd("/home/gilda/dataset9")

#import/save R environment
#save.image(file='dataset9_16S.RData')
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     maxN=0, trimRight=c(10,50), maxEE=c(5,5), truncQ=0, rm.phix=TRUE,
...
dir.create("/home/gilda/dataset9/quality_plots")
library("gridExtra")
#raw forward
...
#101359178 total bases in 348686 reads from 27 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#104056258 total bases in 415936 reads from 30 samples will be used for learning the error rates.
...
#Identified 13486 bimeras out of 20841 input sequences.
dim(seqtab.nochim)
#[1]   37 7355
...
head(track)
write.table(track, file = "dataset9_read_count.txt", sep = "\t")
