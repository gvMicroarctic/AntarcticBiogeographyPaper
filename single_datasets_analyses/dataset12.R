...
#check, import in R and process sequences from dataset 12
...
setwd("/home/gilda/dataset12")

#import/save R environment
#save.image(file='dataset12_16S.RData')
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     maxN=0, trimRight=c(5,35), maxEE=c(5,5), truncQ=0, rm.phix=TRUE,
...
dir.create("/home/gilda/dataset12/quality_plots")
library("gridExtra")
#raw forward
...
#101788550 total bases in 346553 reads from 4 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#105661066 total bases in 408286 reads from 7 samples will be used for learning the error rates.
...
#Identified 1436 bimeras out of 2437 input sequences.
dim(seqtab.nochim)
#[1] 9 1001
...
head(track)
write.table(track, file = "dataset12_read_count.txt", sep = "\t")
