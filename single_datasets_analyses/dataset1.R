...
#check, import in R and process sequences from dataset 1

#check how many reads
#for file in R1_*.fastq.gz 
#do
...
#for file in R1_*.fastq.gz
#do
#filename0="${file%.fastq.gz}"
#filename="${filename0#*_}"
#echo $filename
#java -jar /home/gilda/Trimmomatic-0.39/trimmomatic-0.39.jar PE $file R2_${filename}.fastq.gz ${filename}_R1_paired.fastq.gz ${filename}_R1_unpaired.fastq.gz ${filename}_R2_paired.fastq.gz ${filename}_R2_unpaired.fastq.gz ILLUMINACLIP:../Trimmomatic-0.39/adapters/all.fa:2:30:10
#done

#set working directory
setwd("/home/gilda/dataset1")

#import/save R environment
#save.image(file='dataset1_16S.RData')
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     maxN=0, maxEE=c(5,5), truncQ=0, rm.phix=TRUE,
...
dir.create("/home/gilda/dataset1/quality_plots")
library("gridExtra")
#raw forward
...
#101107133 total bases in 669588 reads from 23 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#101107302 total bases in 669588 reads from 23 samples will be used for learning the error rates.
...
#Identified 1425 bimeras out of 13572 input sequences.
dim(seqtab.nochim)
#[1]   175 12145
...
head(track)
write.table(track, file = "dataset1_read_count.txt", sep = "\t")
