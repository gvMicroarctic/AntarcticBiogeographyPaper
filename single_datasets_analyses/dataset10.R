...
#check, import in R and process sequences from dataset 10
...
setwd("/home/gilda/dataset10")

#import/save R environment
#save.image(file='dataset10_16S.RData')
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     maxN=0, trimRight=c(10,65), maxEE=c(5,5), truncQ=0, rm.phix=TRUE,
...
dir.create("/home/gilda/dataset10/quality_plots")
library("gridExtra")
#raw forward
...
#131609769 total bases in 452700 reads from 5 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, multithread=TRUE)
#106380120 total bases in 452700 reads from 5 samples will be used for learning the error rates.
...
#Identified 45010 bimeras out of 100971 input sequences.
dim(seqtab.nochim)
#[1]   153 55961
...
head(track)
write.table(track, file = "dataset10_read_count.txt", sep = "\t")
